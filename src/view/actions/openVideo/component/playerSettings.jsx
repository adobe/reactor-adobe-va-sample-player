...
import {Item, renderCheckbox, renderRadio, renderTextField} from '../../../utils/uiComponents';
        ...
        <Panel>
            ...
            <Form horizontal className='u-gapTop2x'>
                <FormGroup >
                    ...
                    <Col xs={4}>
                        <Field name='playerSpecificity' defaultChecked={playerSpecificity} options={PlayerSpecificity.items} component={renderRadio} />
                    </Col>
                </FormGroup>
                {
                    ...
                    <FormGroup>
                    <Col xsOffset={2} xs={4}>
                        <Field name='playerId' placeholder="Player Id" component={renderTextField} supportDataElement />
                    </Col>
                    </FormGroup>
                    : null
                }
                <FormGroup >
                    ...
                    <Col xs={4}>
                        <Field name='playerSelector' placeholder="CSS Selector" component={renderTextField} supportDataElement/>
                    </Col>
                </FormGroup>
                <FormGroup >
                    <Col componentClass={ControlLabel} xs={2}> Player Width (px) </Col>
                    <Col xs={2}>
                        <Field name='playerWidth' placeholder="Width" component={renderTextField} supportDataElement/>
                    </Col>
                </FormGroup>
                <FormGroup >
                    <Col componentClass={ControlLabel} xs={2}> Player Height (px) </Col>
                    <Col xs={2}>
                        <Field name='playerHeight' placeholder="Height" component={renderTextField} supportDataElement/>
                    </Col>
                </FormGroup>
                <FormGroup>
...
export default connect(
    state => ({ playerSpecificity: formValueSelector('default')(state, 'playerSpecificity')}
))(PlayerSettings);
