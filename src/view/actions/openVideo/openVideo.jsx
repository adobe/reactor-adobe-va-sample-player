...
function mergeConfig(...configs) {
    ...
    const settingsToFormValuesFns = configs.map(config => config.settingsToFormValues).filter(isFunction);
    const formValuesToSettingsFns =  configs.map(config => config.formValuesToSettings).filter(isFunction);
    const validateFns =  configs.map(config => config.validate).filter(isFunction);
    ...
    console.log(settingsToFormValuesFns);
}
