...
import {Row, Col, Form, FormGroup, ControlLabel} from '../../utils/uiComponents';
    ...
    return (
        <Form horizontal className='u-gapTop2x'>
            <FormGroup>
                ...
                <Col xs={4}>
                    <Field name='playerEvent' componentClass='select' options={EventList.items} component={renderSelect} />
                </Col>
            </FormGroup>
            <FormGroup >
